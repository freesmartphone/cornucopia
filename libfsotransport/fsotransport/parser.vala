...
{
    public abstract bool haveCommand();
    public abstract bool isExpectedPrefix( string line );
    public abstract void solicitedCompleted( string[] response );
    public abstract void unsolicitedCompleted( string[] response );
}
...
public class FsoFramework.LineByLineParser : FsoFramework.BaseParser
{
    ...
    private void endofline()
    {
        ...
        {
            _delegate.unsolicitedCompleted( { (string)curline } );
        }
        else
        {
            _delegate.solicitedCompleted( { (string)curline } );
        }
        resetLine();
    }
